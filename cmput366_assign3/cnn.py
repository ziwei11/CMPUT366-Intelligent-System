...
def cnn(train_x, train_y, test1_x, test1_y, test2_x, test2_y):
    ...
    model = Sequential([
        # TODO: add your implementation here
        # https://tensorflow.google.cn/versions/r2.0/api_docs/python/tf/keras/layers/Conv2D
        Conv2D(32, (5, 5), strides=(1, 1), input_shape=(30,30,1)),
        # https://tensorflow.google.cn/versions/r2.0/api_docs/python/tf/keras/layers/MaxPool2D
